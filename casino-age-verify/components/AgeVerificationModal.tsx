...
export default function AgeVerificationModal({
  ...
  const handleVerification = async () => {
    ...
    if (!phoneRegex.test(phoneNumber)) {
      toast.error('Formato de teléfono inválido. Usa formato internacional (+34123456789)');
      return;
    }
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-600 focus:border-blue-600"
                    />
                  </div>
